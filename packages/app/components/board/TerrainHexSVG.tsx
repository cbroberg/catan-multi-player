    ...
    <>
      <defs>
        <linearGradient id="sea-bg" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#718494" />
          <stop offset="50%" stopColor="#617484" />
          <stop offset="100%" stopColor="#516474" />
        </linearGradient>
      </defs>
      <polygon points={HEX_POINTS} fill="url(#sea-bg)" stroke="#4a5a6a" strokeWidth="1" />
